...
constexpr insn table[] = {
    ...
    INSN(0x5B00000000000000ULL, 0, "XMAD", xmad_signs, xmad_psl36, xmad_mode50, xmad_mrg37, xmad_x38, dgpr0, cc, comma, sgpr8, xmad_h1_53, comma, sgpr20, xmad_h1_35, comma, sgpr39),
    INSN(0x5100000000000000ULL, 0, "XMAD", xmad_signs, xmad_mode50_c, xmad_x54, dgpr0, cc, comma, sgpr8, xmad_h1_53, comma, sgpr39, xmad_h1_52, comma, cbuf),
    INSN(0x4E00000000000000ULL, 0, "XMAD", xmad_signs, xmad_psl55, xmad_mode50_c, xmad_mrg56, xmad_x54, dgpr0, cc, comma, sgpr8, xmad_h1_53, comma, cbuf, xmad_h1_52, comma, sgpr39),
    INSN(0x3600000000000000ULL, 0, "XMAD", xmad_signs, xmad_psl36, xmad_mode50, xmad_mrg37, xmad_x38, dgpr0, cc, comma, sgpr8, xmad_h1_53, comma, imm16, comma, sgpr39),
