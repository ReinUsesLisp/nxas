...
constexpr insn table[] = {
    ...
    INSN(0x5C10000000000000ULL, 0, "IADD", sat<50>, x<43>, dgpr<0>, cc, comma, neg<49>, sgpr<8>, comma, neg<48>, sgpr<20>),
    INSN(0x4C10000000000000ULL, 0, "IADD", sat<50>, x<43>, dgpr<0>, cc, comma, neg<49>, sgpr<8>, comma, neg<48>, cbuf),
    INSN(0x3810000000000000ULL, 0, "IADD", sat<50>, x<43>, dgpr<0>, cc, comma, neg<49>, sgpr<8>, comma, imm, post_neg<48>),
