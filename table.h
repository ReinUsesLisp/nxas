...
constexpr insn table[] = {
    ...
    INSN(0xEB20000000000000ULL, 0, "SUST", image::d, image::ba, image::type, store_cache<24>, image::size, image::clamp, memory::address<false>, comma, sgpr<0>, comma, sgpr<39>),
    INSN(0xEB28000000000000ULL, 0, "SUST", image::d, image::ba, image::type, store_cache<24>, image::size, image::clamp, memory::address<false>, comma, sgpr<0>, comma, uint<13, 36>),
