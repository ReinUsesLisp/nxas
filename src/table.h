...
const insn table[]{
    ...
    INSN(0x5F00000000000000ULL, 0, "VMAD", video::src_format<37, 48>, vmad::imm_format<29, 49>, po<53, 54>, vmad::scale, sat<55>, dgpr<0>, cc, comma, neg<54>, sgpr<8>, video::selector<36, 37>, comma, uinteger<16, 20>, video::selector<28, 29>, comma, neg<53>, sgpr<39>),
