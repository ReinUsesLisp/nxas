...
const insn table[]{
    ...
    INSN(0x7000000000000000ULL, 0, "HFMA2", fp16::merge<49>, fp16::control<57>, sat<52>, dgpr<0>, comma, sgpr<8>, fp16::swizzle<47>, comma, fimm16_high<56>, comma, fimm16_low<29>, comma, neg<51>, sgpr<39>, fp16::swizzle<53>),
    ...
    INSN(0x7800000000000000ULL, 0, "HMUL2", fp16::merge<49>, fp16::control<39>, sat<52>, dgpr<0>, comma, neg<43>, abs<44, sgpr<8>>, fp16::swizzle<47>, comma, fimm16_high<56>, comma, fimm16_low<29>),
    ...
    INSN(0x5C40000000000000ULL, 0, "LOP", lop::bit_op, x<43>, lop::pred_op, pred<48>, comma, dgpr<0>, cc, comma, tilde<39>, sgpr<8>, comma, tilde<40>, sgpr<20>),
    INSN(0x4C40000000000000ULL, 0, "LOP", lop::bit_op, x<43>, lop::pred_op, pred<48>, comma, dgpr<0>, cc, comma, tilde<39>, sgpr<8>, comma, tilde<40>, cbuf),
    INSN(0x3840000000000000ULL, 0, "LOP", lop::bit_op, x<43>, lop::pred_op, pred<48>, comma, dgpr<0>, cc, comma, tilde<39>, sgpr<8>, comma, tilde<40>, imm),
